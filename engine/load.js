...
(() => {
  ...
  const files = ['core.js', 'characters.js', 'iso.js', 'motion.js', 'generative.js', 'illustrate.js', 'components.js',
    ...['bot', 'person', 'cat'].map((c) => `characters/${c}.js`),
    ...['paper', 'blueprint', 'chalk', 'neon', 'minimal', 'pixel', 'ink', 'papercut', 'isometric', 'inked'].map((s) => `styles/${s}.js`)];
